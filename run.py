...
def Review_words(INPUT):
    ...
    while Y_choice != "q":
        ...
        print('\x1b[6;41;3m' ,  List.index[NUM] , '\x1b[0m')
        time.sleep(1)
        print('\n',Word_explan[2],'\n\n',Word_explan[3],'\n\n',Word_explan[4],'\n\n')
...
def Classify_words(INPUT):
    ...
    while Y_choice2 != "q" :
        ...
        print(str(Word_explan[5]).replace( List.index[0],colored),'\n')
        #### the part for "h" - end
        print('\x1b[6;41;3m' + List.index[0] + '\x1b[0m')  # the words with color
        print("\nRecoder:",NUM,"\n")
        Y_choice2 = input_out(2)
        print("Y = ",Y_choice2)
        if Y_choice2 == 'h':
            Word_explan =  List.loc[List.index[0]]
            print(Word_explan[2],'\n\n',Word_explan[3],'\n\n',Word_explan[4],'\n\n')
